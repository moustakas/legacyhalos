...
#srun -n 64 -c 4 shifter --module=mpich-cle6 $LEGACYHALOS_CODE_DIR/bin/legacyhsc/legacyhsc-mpi.sh coadds 4 > coadds.log.1 2>&1 &
#srun -n 64 -c 4 shifter --module=mpich-cle6 $LEGACYHALOS_CODE_DIR/bin/legacyhsc/legacyhsc-mpi.sh ellipse 4 > ellipse.log.1 2>&1 &
#srun -n 64 -c 1 shifter --module=mpich-cle6 $LEGACYHALOS_CODE_DIR/bin/legacyhsc/legacyhsc-mpi.sh htmlplots 1 > htmlplots.log.1 2>&1 &
...
if [ $stage = "test" ]; then
    ...
    time python $LEGACYHALOS_CODE_DIR/bin/legacyhsc/legacyhsc-mpi --coadds --nproc $ncores --mpi --verbose
