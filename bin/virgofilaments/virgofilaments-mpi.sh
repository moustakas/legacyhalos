...
#srun -n 256 -c 1 --kill-on-bad-exit=0 --no-kill shifter --module=mpich-cle6 $LEGACYHALOS_CODE_DIR/bin/virgofilaments/virgofilaments-mpi.sh htmlplots 32 > /global/cscratch1/sd/ioannis/virgofilaments-data/logs/virgofilaments-htmlplots.log.1 2>&1 &
