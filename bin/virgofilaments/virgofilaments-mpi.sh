...
# perlmutter
#salloc -N 4 -C cpu -A desi -L cfs -t 02:00:00 --qos interactive --image=legacysurvey/legacyhalos:v1.2
#srun -n 8 -c 16 shifter --module=mpich $LEGACYHALOS_CODE_DIR/bin/virgofilaments/virgofilaments-mpi.sh coadds 16 > /global/cfs/cdirs/desi/users/ioannis/virgofilaments-data/logs/virgofilaments-coadds.log.1 2>&1 &
...
#srun -n 8 -c 16 shifter --module=mpich-cle6-cle6 $LEGACYHALOS_CODE_DIR/bin/virgofilaments/virgofilaments-mpi.sh coadds 16 > /global/cfs/cdirs/desi/users/ioannis/virgofilaments-data/logs/virgofilaments-coadds.log.1 2>&1 &
#srun -n 128 -c 4 shifter --module=mpich-cle6-cle6 $LEGACYHALOS_CODE_DIR/bin/virgofilaments/virgofilaments-mpi.sh rebuild-unwise 4 > /global/cfs/cdirs/desi/users/ioannis/virgofilaments-data/logs/virgofilaments-rebuild-unwise.log.1 2>&1 &
#srun -n 8 -c 16 shifter --module=mpich-cle6-cle6 $LEGACYHALOS_CODE_DIR/bin/virgofilaments/virgofilaments-mpi.sh ellipse 16 > /global/cfs/cdirs/desi/users/ioannis/virgofilaments-data/logs/virgofilaments-ellipse.log.1 2>&1 &
#srun -n 256 -c 1 shifter --module=mpich-cle6-cle6 $LEGACYHALOS_CODE_DIR/bin/virgofilaments/virgofilaments-mpi.sh htmlplots 32 > /global/cfs/cdirs/desi/users/ioannis/virgofilaments-data/logs/virgofilaments-htmlplots.log.1 2>&1 &
...
if [ $stage = "test" ]; then
    ...
    time python $LEGACYHALOS_CODE_DIR/bin/virgofilaments/virgofilaments-mpi --ellipse --nproc $ncores --mpi --d25max 10
